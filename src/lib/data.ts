...
const pujas: Puja[] = [
  ...
  { id: 2, name: "కేదారేశ్వర వ్రతము", name_en: "Kedareshwara Vratam", description: "Performed for health and prosperity, dedicated to Lord Shiva.", description_te: "ఆరోగ్యం మరియు శ్రేయస్సు కోసం ప్రదర్శించబడింది, శివునికి అంకితం చేయబడింది.", category: "వ్రతాలు", category_en: "Vratas", image: "https://images.unsplash.com/photo-1623869348915-a0b809249a5b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxzaGl2YSUyMGxpbmdhbXxlbnwwfHx8fDE2OTk4NzU4ODl8MA&ixlib=rb-4.0.3&q=80&w=1080", imageHint: 'shiva lingam' },
  { id: 3, name: "అనంత పద్మనాభ స్వామి వ్రతం", name_en: "Ananta Padmanabha Swamy Vratam", description: "Honoring Lord Ananta Padmanabha Swamy for blessings.", description_te: "ఆశీర్వాదం కోసం శ్రీ అనంత పద్మనాభ స్వామిని గౌరవించడం.", category: "వ్రతాలు", category_en: "Vratas", image: "https://images.unsplash.com/photo-1610405221295-566b75f85b31?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxs%73cmQlMjB2ZW5rYXRlc3dhcmF8ZW58MHx8fHwxNjk5ODc1OTYxfDA&ixlib=rb-4.0.3&q=80&w=1080", imageHint: 'lord vishnu' },
  ...
  { id: 18, name: "కన్యా పాశుపత హోమము", name_en: "Kanya Pasupata Homam", description: "Homa for unmarried women seeking a good husband.", description_te: "మంచి భర్తను కోరుకునే అవివాహిత మహిళల కోసం హోమం.", category: "హోమాలు", category_en: "Homams", image: "https://images.unsplash.com/photo-1601121833543-b3a125341620?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxoaW5kdSUyMHByYXllciUyMG9mZmVyaW5nfGVufDB8fHx8MTY5OTg3NTg4OXww&ixlib=rb-4.0.3&q=80&w=1080", imageHint: "marriage ritual" },
  ...
  { id: 21, name: "ఋణ విమోచన హోమము", name_en: "Runa Vimochana Homam", description: "Homa to get relief from debts and financial burdens.", description_te: "అప్పులు, ఆర్థిక భారాల నుంచి ఉపశమనం పొందేందుకు హోమం.", category: "హోమాలు", category_en: "Homams", image: "https://images.unsplash.com/photo-1542444538-a3d4923581b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHx5YWduYSUyMGZpcmV8ZW58MHx8fHwxNzAxMjQ2MTMzfDA&ixlib=rb-4.0.3&q=80&w=1080", imageHint: "financial freedom" },
