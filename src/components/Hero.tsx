  ...
  return (
    <section className="w-full bg-[#050505] min-h-[90vh] flex items-center relative overflow-hidden py-16 md:py-28 border-b border-white/[0.03]">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none flex items-center justify-center">
        ...
        <span className="absolute right-[8%] top-[12%] text-white/[0.015] text-[280px] font-bold select-none pointer-events-none font-serif leading-none animate-float">ॐ</span>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="text-left flex flex-col items-start lg:col-span-7 space-y-6 md:space-y-8 -mt-4 lg:-mt-8">
            ...
            <p className="max-w-2xl text-lg md:text-xl text-white/70 leading-relaxed font-light font-sans tracking-wide">
              {subtitle}
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-6 pt-6 w-full max-w-lg">
              {[
                ...
                <div key={stat.label} className="glass-card rounded-2xl p-4 text-center border border-white/[0.04] bg-white/[0.01] hover:border-primary/20 hover:bg-white/[0.03] transition-all duration-500">
                  ...
                  <p className="text-[10px] md:text-xs text-white/50 font-medium tracking-widest uppercase mt-1.5">{stat.label}</p>
                </div>
              ))}
            </div>
          ...
          <div className="hidden lg:flex lg:col-span-5 relative justify-center items-center h-[550px] w-full">
            ...
            <div className="absolute transform -translate-x-12 -translate-y-16 scale-95 z-10 w-[240px] glass-card border border-white/[0.04] bg-white/[0.01] rounded-3xl p-4 shadow-[0_15px_40px_rgba(0,0,0,0.6)] hover:-translate-y-20 transition-all duration-500">
              ...
              <div className="mt-3 text-left">
                <h3 className="text-base font-bold text-white tracking-tight">Lord Ganesha</h3>
                <p className="text-xs text-white/50 mt-1 line-clamp-1">Veneration before every new endeavor</p>
              </div>
            </div>

            {/* Overlapping Glassmorphic Card 2 (Shiva - Cosmic Consciousness) */}
            <div className="absolute transform translate-x-16 translate-y-12 z-20 w-[260px] glass-card border border-white/[0.06] bg-white/[0.02] rounded-3xl p-5 shadow-[0_20px_50px_rgba(0,0,0,0.8)] hover:translate-y-8 transition-all duration-500">
              ...
              <div className="mt-4 text-left">
                <h3 className="text-lg font-bold text-white tracking-tight">Lord Shiva</h3>
                <p className="text-xs text-white/60 mt-1.5 leading-relaxed line-clamp-2">Supreme meditative energy & cosmic purification</p>
              </div>
            </div>
