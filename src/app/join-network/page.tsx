    ...
    <div className="min-h-screen pb-16">
      ...
      <section className="divine-bg relative overflow-hidden py-20 md:py-28 text-center">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <img src="/logo.png" alt="" className="absolute top-8 left-[10%] w-[180px] h-[180px] rounded-full object-cover grayscale opacity-[0.03] select-none pointer-events-none" />
          <img src="/logo.png" alt="" className="absolute bottom-0 right-[8%] w-[150px] h-[150px] rounded-full object-cover grayscale opacity-[0.03] select-none pointer-events-none" />
          <img src="/logo.png" alt="" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[320px] h-[320px] rounded-full object-cover grayscale opacity-[0.02] select-none pointer-events-none" />
        </div>
