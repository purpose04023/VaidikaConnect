  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden pt-6 pb-16 md:pt-10 md:pb-24">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none flex items-center justify-center">
        ...
        />
        <img src="/logo.png" alt="" className="absolute left-[5%] bottom-[10%] w-[200px] h-[200px] rounded-full object-cover grayscale opacity-[0.01] select-none pointer-events-none" />
      </div>
